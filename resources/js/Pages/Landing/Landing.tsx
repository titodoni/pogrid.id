...
const translations = {
    ...
    id: {
        ...
        meta_desc: 'Pantau progress Purchase Order pabrik CNC, fabrikasi, dan machining dari HP secara real-time. Operator input pakai PIN 4 digit. Owner tahu mana PO yang aman, rawan, atau terlambat — sebelum kena pinalti. Coba gratis 30 hari.',
        ...
        og_title: 'POgrid.id — Pantau Progress PO Pabrik Langsung dari HP (Real-Time)',
        og_desc: 'Operator update via HP pakai PIN 4 digit. Owner pantau status order aman/delay di dashboard. Tanpa ribet instalasi ERP.',
        ...
        schema_desc: 'Sistem pelacakan progress Purchase Order (PO) dan kontrol ketepatan pengiriman khusus pabrik manufaktur, workshop CNC, dan fabrikasi di Indonesia.',
        ...
        hero_title_1: 'Ketahui persis posisi',
        hero_title_2: 'setiap order Anda.',
        hero_title_3: 'Saat ini juga.',
        ...
        pain_items: [
            ...
            { q: 'Tahu-tahu telat di hari-H kirim & kena denda pinalti', a: 'Tidak ada warning dari awal. Keterlambatan baru ketahuan saat armada siap muat, berujung denda atau pembatalan order.' },
            { q: 'Progres pengerjaan cuma dicatat di kertas & papan tulis', a: 'Surat jalan/SPK lecek, hilang, atau operator lupa update. Owner kesulitan memantau progress riil di lapangan.' },
        ...
        sim_client_tracker: 'Client Tracker',
        sim_po_code: 'Kode PO',
        sim_progress_label: 'Progress pengerjaan item:',
        ...
        sim_operator_label: 'Operator:',
        sim_operator_value: 'Joko Susilo (Welding)',
        sim_enter_pin: 'Masukkan 4-digit PIN Anda:',
