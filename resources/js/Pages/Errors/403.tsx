    ...
    return (
        <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', backgroundColor: 'var(--color-pg-bg)', fontFamily: 'Inter, sans-serif', color: 'var(--color-pg-text)', padding: '16px' }}>
            <div style={{ textAlign: 'center' }}>
                ...
                <p style={{ color: 'var(--color-pg-text-secondary)', fontSize: '18px', marginTop: '8px' }}>Forbidden</p>
                <p style={{ color: 'var(--color-pg-text-muted)', fontSize: '14px', marginTop: '4px' }}>You don't have permission to access this resource.</p>
